...
public class SpruceDrawerGuiMenu extends AbstractContainerMenu {
	...
	public SpruceDrawerGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	public SpruceDrawerGuiMenu(int id, Inventory inv, Container container) {
		super(DrawerModMenus.SPRUCE_DRAWER_GUI, id);
