...
public class AcaciaDrawerGuiMenu extends AbstractContainerMenu {
	...
	public AcaciaDrawerGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	public AcaciaDrawerGuiMenu(int id, Inventory inv, Container container) {
		super(DrawerModMenus.ACACIA_DRAWER_GUI, id);
