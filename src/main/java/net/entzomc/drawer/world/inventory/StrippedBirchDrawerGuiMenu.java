...
public class StrippedBirchDrawerGuiMenu extends AbstractContainerMenu {
	...
	public StrippedBirchDrawerGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	public StrippedBirchDrawerGuiMenu(int id, Inventory inv, Container container) {
		super(DrawerModMenus.STRIPPED_BIRCH_DRAWER_GUI, id);
