...
public class StrippedMangroveDrawerGuiMenu extends AbstractContainerMenu {
	...
	public StrippedMangroveDrawerGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	public StrippedMangroveDrawerGuiMenu(int id, Inventory inv, Container container) {
		super(DrawerModMenus.STRIPPED_MANGROVE_DRAWER_GUI, id);
