...
public class BirchDrawerGuiMenu extends AbstractContainerMenu {
	...
	public BirchDrawerGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	public BirchDrawerGuiMenu(int id, Inventory inv, Container container) {
		super(DrawerModMenus.BIRCH_DRAWER_GUI, id);
