...
public class DarkOakDrawerGuiMenu extends AbstractContainerMenu {
	...
	public DarkOakDrawerGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	public DarkOakDrawerGuiMenu(int id, Inventory inv, Container container) {
		super(DrawerModMenus.DARK_OAK_DRAWER_GUI, id);
