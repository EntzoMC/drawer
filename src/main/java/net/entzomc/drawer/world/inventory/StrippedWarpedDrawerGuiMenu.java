...
public class StrippedWarpedDrawerGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public StrippedWarpedDrawerGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(DrawerModMenus.STRIPPED_WARPED_DRAWER_GUI.get(), id);
