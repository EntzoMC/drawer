...
public class StrippedWarpedDrawerGuiMenu extends AbstractContainerMenu {
	...
	public StrippedWarpedDrawerGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	public StrippedWarpedDrawerGuiMenu(int id, Inventory inv, Container container) {
		super(DrawerModMenus.STRIPPED_WARPED_DRAWER_GUI, id);
