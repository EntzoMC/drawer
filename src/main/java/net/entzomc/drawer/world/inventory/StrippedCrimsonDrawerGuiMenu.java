...
public class StrippedCrimsonDrawerGuiMenu extends AbstractContainerMenu {
	...
	public StrippedCrimsonDrawerGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	public StrippedCrimsonDrawerGuiMenu(int id, Inventory inv, Container container) {
		super(DrawerModMenus.STRIPPED_CRIMSON_DRAWER_GUI, id);
