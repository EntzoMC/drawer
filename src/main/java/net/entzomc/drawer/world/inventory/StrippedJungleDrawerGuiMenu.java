...
public class StrippedJungleDrawerGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public StrippedJungleDrawerGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(DrawerModMenus.STRIPPED_JUNGLE_DRAWER_GUI.get(), id);
