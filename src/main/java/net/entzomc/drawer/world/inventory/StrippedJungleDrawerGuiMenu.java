...
public class StrippedJungleDrawerGuiMenu extends AbstractContainerMenu {
	...
	public StrippedJungleDrawerGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	public StrippedJungleDrawerGuiMenu(int id, Inventory inv, Container container) {
		super(DrawerModMenus.STRIPPED_JUNGLE_DRAWER_GUI, id);
