...
public class CherryDrawerGuiMenu extends AbstractContainerMenu {
	...
	public CherryDrawerGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	public CherryDrawerGuiMenu(int id, Inventory inv, Container container) {
		super(DrawerModMenus.CHERRY_DRAWER_GUI, id);
