...
public class StrippedSpruceDrawerGuiMenu extends AbstractContainerMenu {
	...
	public StrippedSpruceDrawerGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	public StrippedSpruceDrawerGuiMenu(int id, Inventory inv, Container container) {
		super(DrawerModMenus.STRIPPED_SPRUCE_DRAWER_GUI, id);
