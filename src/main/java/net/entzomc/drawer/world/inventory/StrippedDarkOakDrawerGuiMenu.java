...
public class StrippedDarkOakDrawerGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public StrippedDarkOakDrawerGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(DrawerModMenus.STRIPPED_DARK_OAK_DRAWER_GUI.get(), id);
