...
public class StrippedDarkOakDrawerGuiMenu extends AbstractContainerMenu {
	...
	public StrippedDarkOakDrawerGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	public StrippedDarkOakDrawerGuiMenu(int id, Inventory inv, Container container) {
		super(DrawerModMenus.STRIPPED_DARK_OAK_DRAWER_GUI, id);
