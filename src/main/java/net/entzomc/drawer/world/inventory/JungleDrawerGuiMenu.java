...
public class JungleDrawerGuiMenu extends AbstractContainerMenu {
	...
	public JungleDrawerGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	public JungleDrawerGuiMenu(int id, Inventory inv, Container container) {
		super(DrawerModMenus.JUNGLE_DRAWER_GUI, id);
