...
public class WarpedDrawerGuiMenu extends AbstractContainerMenu {
	...
	public WarpedDrawerGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	public WarpedDrawerGuiMenu(int id, Inventory inv, Container container) {
		super(DrawerModMenus.WARPED_DRAWER_GUI, id);
