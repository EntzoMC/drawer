...
public class CrimsonDrawerGuiMenu extends AbstractContainerMenu {
	...
	public CrimsonDrawerGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	public CrimsonDrawerGuiMenu(int id, Inventory inv, Container container) {
		super(DrawerModMenus.CRIMSON_DRAWER_GUI, id);
