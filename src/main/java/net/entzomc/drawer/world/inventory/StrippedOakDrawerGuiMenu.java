...
public class StrippedOakDrawerGuiMenu extends AbstractContainerMenu {
	...
	public StrippedOakDrawerGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	public StrippedOakDrawerGuiMenu(int id, Inventory inv, Container container) {
		super(DrawerModMenus.STRIPPED_OAK_DRAWER_GUI, id);
