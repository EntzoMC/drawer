...
public class StrippedOakDrawerGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public StrippedOakDrawerGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(DrawerModMenus.STRIPPED_OAK_DRAWER_GUI.get(), id);
