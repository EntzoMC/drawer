...
public class StrippedAcaciaDrawerGuiMenu extends AbstractContainerMenu {
	...
	public StrippedAcaciaDrawerGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	public StrippedAcaciaDrawerGuiMenu(int id, Inventory inv, Container container) {
		super(DrawerModMenus.STRIPPED_ACACIA_DRAWER_GUI, id);
