...
public class StrippedAcaciaDrawerGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public StrippedAcaciaDrawerGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(DrawerModMenus.STRIPPED_ACACIA_DRAWER_GUI.get(), id);
